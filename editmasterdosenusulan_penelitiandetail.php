...
echo "<form action=editmasterdosenusulan_penelitiandetailexec.php method=post>";
$result = mysqli_query($con, "SELECT * FROM usulan_penelitian where id = ". $_GET['id'] . "");
...
echo "<td bgcolor=CCEEEE>&nbsp;&nbsp;<input type=text id='Tanggal' name='Tanggal' value='" . $row['Tanggal'] . "'><script type='text/javascript'>calendar.set('Tanggal');</script></td>";
echo "<tr><td bgcolor=CCCCCC><font face=Verdana color=black size=1>&nbsp;&nbsp;Ruang&nbsp;&nbsp;</font></td>";
echo "<td bgcolor=CCEEEE><input type=text  class='form-control' name='Ruang' value='" . $row['Ruang'] . "' size = 100></td></tr>";
