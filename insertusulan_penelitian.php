...
<Br>
	<?php
	//cek otoritas
	$q = "SELECT * FROM tw_hak_akses where tabel='usulan_penelitian' and user = '" . $_SESSION['Email'] . "' and insertData='1'";
	...
	?>
		...
		echo "<form action=insertusulan_penelitianexec.php method=post enctype='multipart/form-data'>";
		...
		echo "<td bgcolor=CCEEEE><input type=text id='Tanggal' name='Tanggal'><font face=Verdana color=black size=1><script type='text/javascript'>calendar.set('Tanggal');</script></font></td>";
		echo "<tr><td bgcolor=CCCCCC><font face=Verdana color=black size=1>Ruang</font></td>";
		echo "<td bgcolor=CCEEEE><input type=text  class='form-control' name='Ruang' size = 100></td>";
