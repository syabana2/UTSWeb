...
?>
<?php
echo "<br><font face=Verdana color=black size=1>dosen</font><br><br>";
...
<th></th>
<th></th>
<th><font face=Verdana color=black size=1>NIDN</font></th>
...
while($row = mysqli_fetch_array($result))
  ...
  echo "<td><a class=linklist href=viewdosen.php?NIDN=".$row['NIDN']."><button type='button' class='btn btn-warning'><font face=Verdana size=1><i class='fa fa-check'></i></font></button></a></td>";
  echo "<td><a class=linklist href=editdosen.php?NIDN=".$row['NIDN']."><button type='button' class='btn btn-primary'><font face=Verdana size=1><i class='fa fa-edit'></i></font></button></a></td>";
  echo "<td><a class=linklist href=deletedosen.php?NIDN=".$row['NIDN']." onclick=\"return confirm('Are you sure you want to delete this data?')\"><button type='button' class='btn btn-danger'><font face=Verdana size=1><i class='fa fa-trash'></i></font></button></a></td>";
