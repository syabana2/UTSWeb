...
<div id="page-wrapper">
	...
	echo "<form action=insertmasterdosenusulan_penelitiandetailexec.php method=post>";
	...
	echo "<td bgcolor=CCEEEE><input type=text id='Tanggal' name='Tanggal'><script type='text/javascript'>calendar.set('Tanggal');</script></td></tr>";
	echo "<tr><td bgcolor=CCCCCC><font face=Verdana color=black size=1>Ruang</font></td>";
	echo "<td bgcolor=CCEEEE><input type=text  class='form-control' name='Ruang' size = 100></td></tr>";
