...
?>
<div id="page-wrapper"> 
<form action="uploadimagedosenexec.php" method="post" enctype="multipart/form-data"> 
<input type=text  class='form-control' name=NIDN value=<?php echo $_GET['NIDN']; ?> hidden><br> 
