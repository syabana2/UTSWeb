...
<body topmargin=0 leftmargin=0 marginwidth=0 marginheight=0 bgcolor=FFFFFF>
	...
	?>
	<div id="page-wrapper">
		<form action="uploadimagemahasiswaexec.php" method="post" enctype="multipart/form-data">
			<input type=text class='form-control' name=NIM value=<?php echo $_GET['NIM']; ?> hidden><br>
